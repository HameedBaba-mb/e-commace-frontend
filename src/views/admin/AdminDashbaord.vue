          ...
          <div class="row">
                    ...
                    <table class="table text-nowrap align-middle mb-0">
                      ...
                      <tbody class="table-group-divider">
                        ...
                        <tr>
                          <th scope="row" class="ps-0 fw-medium">
                            <span class="table-link1 text-truncate d-block"
                              >Modern Admin Dashboard Template</span
                            >
                          </th>
                          <td>
                            <a
                        ...
                        <tr>
                          <th scope="row" class="ps-0 fw-medium">
                            <span class="table-link1 text-truncate d-block"
                              >Explore our product catalog</span
                            >
                          </th>
                          <td>
                            <a
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  <h5
                    class="card-title d-flex align-items-center gap-2 mb-5 pb-3"
                  >
                    Sessions by device<span
                      ><i
                  ...
                  <div class="row">
                    <div class="col-4">
                      <i
                        ...
                        class="fs-7 d-flex text-primary"
                      ></i>
                    ...
                    <div class="col-4">
                      <i
                        ...
                        class="fs-7 d-flex text-secondary"
                      ></i>
                      <span class="fs-11 mt-2 d-block text-nowrap"
                        >Smartphone</span
                      >
              ...
              <div class="card overflow-hidden hover-img">
                ...
                <div class="card-body p-4">
                  ...
                  <a
                    class="d-block my-4 fs-5 text-dark fw-semibold link-primary"
                    href=""
                    >COVID outbreak deepens as more lockdowns loom in China</a
                  >
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-2">
